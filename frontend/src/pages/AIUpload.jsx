  ...
  return (
    <div
      ...
      style={{
        ...
        background: drag ? "rgba(124,58,237,.05)" : file ? "#000" : "#fafbfd",
...
export default function AIUpload() {
  ...
  return (
    /* root — fills .page-area flex column, no overflow */
    <div className="row g-3 flex-nowrap" style={{ flex: 1, minHeight: 0, overflow: "hidden", margin: 0, padding: "1rem", width: "100%", boxSizing: "border-box" }}>

      {/* ══ LEFT: upload panel ══ */}
      <div className="col-6 d-flex flex-column" style={{ minHeight: 0 }}>
