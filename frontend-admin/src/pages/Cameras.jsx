          ...
          <tr key={item.id} style={{ opacity: isDeleting ? .5 : 1 }}>
            ...
            <td className="cam-td">
              <button
                ...
                style={{ background: st.bg, color: st.color, cursor: isAdminUser ? "pointer" : "default" }}
                onClick={() => isAdminUser && handleToggleActive(item)}
                disabled={!isAdminUser || isDeleting}
                title={isAdminUser ? t("cam.toggleStatus") : ""}
              >
